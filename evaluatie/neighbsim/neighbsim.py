...
class NeighBSimArgs(msgspec.Struct, frozen=True):
    ...
    def from_binary_ids(
        ...
        """Queries the database to create the args."""
        return cls(
            query_binary_id=query_binary_id,
            target_binary_id=target_binary_id,
            query_call_graph=dataset.binary_id2call_graph[query_binary_id],
            target_call_graph=dataset.binary_id2call_graph[target_binary_id],
            similarity_graph=dataset.binary_ids2similarity_graph[
                (query_binary_id, target_binary_id)
            ],
        )
